    ...
    return (
      ...
      <div className="row">
        ...
        <div className="col-md-3 col-sm-6">
            <h4>Services</h4>
            <ul className="list-unstyled">
            <li><a href="./Home" onClick={scrollToEvents}>Photobooth</a></li>
            <li><a href="./Home" onClick={scrollToEvents}> 360 Booth</a></li>
            <li><a href="./Home" onClick={scrollToEvents}>Slowmo Booth</a></li>
